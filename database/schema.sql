...
CREATE TABLE users (
    ...
    profile_picture_url VARCHAR(255), --avatar
    bio VARCHAR(255),
    -- redis ile yönetilecek
    status VARCHAR(20) DEFAULT 'offline',     -- online, offline, away, busy vb.
    socket_id VARCHAR(100),                   -- Socket.IO bağlantı ID'si
    
    last_seen TIMESTAMP WITH TIME ZONE DEFAULT NOW(), --logout
    
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(), 
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW() -- herhangi bir update sorgusu geldiğinde trigger ile güncellenecek
);
...
CREATE TABLE friendships (
    ...
    accepted_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(), -- eğer reddedildiyse friendship objesi silinir
...
CREATE TABLE chat_groups (
    ...
    -- description TEXT, --ZORUNLU DEĞİL
...
CREATE TABLE messages (
    ...
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(), -- Mesaj düzenlendiğinde güncellenecek
...
/* Bu kısım redis ile yönetilecek
...
*/
-- NOT: Kullanıcı oturum bilgileri Redis ile yönetilecektir.
